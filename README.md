...
<body>
    ...
    <!-- ===== NAVBAR ===== -->
    <nav class="navbar">
        <div class="logo">Pahlavi Role Play</div>
    ...
    <section id="home" class="hero">
        <h1 class="glitch" data-text="Pahlavi Role Play">Pahlavi Role Play</h1>
    ...
    <section id="team" class="section">
        ...
        <div class="cards">
            <div class=<span style="color: #ff5555; text-shadow: 0 0 20px #ff0000;">TMS PAHLAVI BAX</span></div>
        </div>
    </section>
    ...
    <!-- ===== FOOTER ===== -->
    <footer>
        <p>⚡ <span>Pahlavi ROLEPLAY</span> | تمامی حقوق محفوظ است © 2026</p>
    ...
    <script>
        ...
        // ===== TYPING EFFECT =====
        const text = "به سرور Pahlavi Role Play خوش آمدید، سروری جذاب و پر چالش با ایونت های هیجان انگیز";
        let i = 0;
